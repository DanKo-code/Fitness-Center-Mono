    ...
    >
      ...
      <div style={{ height: "100vh", marginRight: "5%", marginLeft: "5%" }}>
        <div style={{ marginTop: "50px", fontSize: "18px" }}>
          Добро пожаловать в FitLab — современное приложение для фитнес-центра,
          которое открывает доступ к тренировкам с профессиональными и
          известными тренерами как в зале, так и онлайн. Выбирайте направления,
          оформляйте абонементы с удобными тарифами, изучайте профили тренеров,
          оставляйте отзывы, редактируйте свой профиль и отслеживайте историю
          покупок и расписание предстоящих тренировок.
        </div>
        <div>
